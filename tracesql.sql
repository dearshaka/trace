...
CREATE TABLE IF NOT EXISTS `trace`.`trace_barcode` (
  ...
  `attr01` VARCHAR(200) NULL COMMENT '自定义属性1',
  `attr02` VARCHAR(200) NULL COMMENT '自定义属性2',
  `attr03` VARCHAR(200) NULL COMMENT '自定义属性3',
  `attr04` VARCHAR(200) NULL COMMENT '自定义属性4',
  `attr05` VARCHAR(200) NULL COMMENT '自定义属性5',
  `attr06` VARCHAR(200) NULL COMMENT '自定义属性6',
  `attr07` VARCHAR(200) NULL COMMENT '自定义属性7',
  `attr08` VARCHAR(200) NULL COMMENT '自定义属性8',
  `attr09` VARCHAR(200) NULL COMMENT '自定义属性9',
  `attr10` VARCHAR(200) NULL COMMENT '自定义属性10',
...
CREATE TABLE IF NOT EXISTS `trace`.`trace_input_detail` (
  ...
  `batch_no` VARCHAR(100) NULL COMMENT '批次号',
  `work_order_code` VARCHAR(64) NULL COMMENT '工单号\n',
